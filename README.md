...
### Install
`npm i @hishprorg/recusandae-esse`
...
```javascript
const {CStructBE,CStructLE, hexToBuffer, AtomTypes} = require('@hishprorg/recusandae-esse');
...
**Make example**<br>
```typescript
import { CStructBE, CStructProperty } from '@hishprorg/recusandae-esse';
...
```typescript
import { CStructBE, CStructClass } from '@hishprorg/recusandae-esse';
...
### [Many examples are in this folder '/examples'](https://github.com/hishprorg/recusandae-esse/tree/main/examples)

### Basic examples
```typescript
import { CStructBE } from '@hishprorg/recusandae-esse';
...
**NOTE** Take a look on ['/examples/decorators.ts'](https://github.com/hishprorg/recusandae-esse/tree/main/examples/decorators.ts)
...
```typescript
import { CStructBE, CStructClass, CStructModelProperty } from '@hishprorg/recusandae-esse';
...
### [TODO](https://github.com/hishprorg/recusandae-esse/blob/main/doc/TODO.md)
